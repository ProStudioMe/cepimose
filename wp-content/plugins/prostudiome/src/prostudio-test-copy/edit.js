	...
	return (
		<>
			...
			<div {...blockProps}>
				<Placeholder
					icon="admin-tools"
					label={__("Test Copy Block", "prostudiome")}
					instructions={__(
						"This is a copy of the working Same Category Posts block to test registration.",
						"prostudiome",
					)}
				>
					<div>
						...
						<ul style={{ textAlign: "left" }}>
							<li>
								{__("Title:", "prostudiome")} {title}
							</li>
							<li>
								{__("Number of posts:", "prostudiome")} {numberOfPosts}
							</li>
							<li>
								{__("Featured image:", "prostudiome")}
								{displayFeaturedImage
									? __("Shown", "prostudiome")
									: __("Hidden", "prostudiome")}
							</li>
							<li>
