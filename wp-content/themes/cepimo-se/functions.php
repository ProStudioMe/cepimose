        ...
        if (file_exists($media_text_blue_file)) {
            ...
            register_block_pattern(
                ...
                array(
                    ...
                    'description' => __('A media-text block with blue styling and rounded borders', 'cepimo-se'),
        ...
        if (file_exists($sidebar_aside_file)) {
            ...
            register_block_pattern(
                ...
                array(
                    ...
                    'description' => __('A customizable aside sidebar with widgets for recent posts, categories, tags, and archives', 'cepimo-se'),
                    'content'     => trim($sidebar_aside_content),
                    'categories'  => array('cepimose'),
                    'keywords'    => array('sidebar', 'aside', 'widgets', 'navigation', 'recent posts', 'categories'),
                )
            );
        }
    }
